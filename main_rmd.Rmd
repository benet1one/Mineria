...
The Exploratory Data Analysis revealed intricate, comlpex relationships between the variables.
...
readRDS("data/songs_outlied.RDS") |> 
    ggplot(aes(x = instrumentalness, y = speechiness, color = 1 - outlier_weight)) +
    geom_point(size = 2) +
